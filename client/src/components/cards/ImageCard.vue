      ...
      >
        <div class="row" style="width: 100%">
          ...
          >
            ...
            <button class="btn dropdown-item" @click="onDownloadSegmentedClick">
...
const onDownloadClick = () => {
  downloadURI(
    "/api/image/" + props.image.id + "?asAttachment=true",
...
const onDownloadSegmentedClick = () => {
  downloadURI(
    "/api/image/segmented/" + props.image.id + "?asAttachment=true",
    props.image.file_name
  );
};
