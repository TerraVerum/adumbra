<template>
  <div>
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            >
              Create Dataset From Volume
            </button>
            <button
              type="button"
              class="btn btn-info btn-block"
              @click="volumesUploadModal && volumesUploadModal.show()"
            >
              Import Volume
            </button>
            <button
    ...
    <GenericDialog
      ref="volumeUploadDialog"
      :title="'Upload Volumes'"
      :action="'Upload'"
      @click-action="importVolumes"
    >
      <form>
        <div class="form-group">
          <label for="imageUpload">Volume file(s) (.npy)</label>
          <input
...
let volumesUploadModal = null;
const volumesUploadDialog = useTemplateRef("volumeUploadDialog");
...
const importVolumes = () => {
  console.log("VASANTH HERE ")
  console.log(volumeFilesInput)
...
onMounted(() => {
  updatePage();
  volumesUploadModal = new Modal(volumesUploadDialog.value.$el, {});
});
